...
pub fn request_account_summary(
  ...
  io.println("[Encoder] REQ_ACCOUNT_SUMMARY: " <> result)
  result
}
...
pub fn request_positions(request_id: Int) -> String {
  ...
  io.println("[Encoder] REQ_POSITIONS: " <> result)
  result
}
...
pub fn request_open_orders() -> String {
  ...
  io.println("[Encoder] REQ_OPEN_ORDERS: " <> result)
  result
}
...
/// Create START_API message (client ID message)
...
pub fn start_api_message(client_id: Int) -> String {
  ...
  io.println("[Encoder] START_API: " <> result)
  result
}
